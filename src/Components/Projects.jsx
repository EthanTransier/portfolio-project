  ...
  return (
    <section className="main-projects">
      <div id="projects-circle" >
        ...
        <ProjectCard num={3} title="INTERNSHIP PORTFOLIO" url="/images/sydney-curtis.png" link="" link2="https://scurtisphd.com/home"></ProjectCard>
        ...
        <ProjectCard num={7} title="WEB PORTFOLIO" url="/images/web-portfolio.png" link="portfolio-project"></ProjectCard>
